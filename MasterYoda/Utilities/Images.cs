...
namespace MasterYoda.Utilities
{
    public class Images
    {
        public async Task<string> CreateImageAsync(SocketGuildUser user)
        {
            ...
            var background = await FetchImageAsync("https://images.unsplash.com/photo-1444080748397-f442aa95c3e5?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1490&q=80");
            ...
            banner = DrawTextToImage(banner, $"{user.Username}#{user.Discriminator} den Raum betreten hat",$"Member #{user.Guild.MemberCount}");
        ...
        private static Bitmap CropToBanner(Image image)
        {
            ...
            var sourceRect = new Rectangle(startX, startY, widthScale, heightScale);
            var bitmap = new Bitmap(destinationSize.Width, destinationSize.Height);
            var destinationRectangle = new Rectangle(0, 0, bitmap.Width, bitmap.Height);

            using var g = Graphics.FromImage(bitmap);
            g.InterpolationMode = System.Drawing.Drawing2D.InterpolationMode.HighQualityBicubic;
            g.DrawImage(image, destinationRectangle, sourceRect, GraphicsUnit.Pixel);
        ...
        private Image DrawTextToImage(Image image, string header, string subheader)
        {
            ...
            var subHeaderY = (image.Width / 2) + 160;
        ...
        private async Task<Image> FetchImageAsync(string url)
        {
            ...
            {
                var backupResponse = await client.GetAsync("https://images.unsplash.com/photo-1558196750-dd70dae770d2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80");
